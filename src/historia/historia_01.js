...
export async function historia1(heroi) {
  ...
  while (MISSÕES.length > 0) {
    // aqui so iremos sair do loop após concluir toda a missão
    const missao1 = {
      type: "list",
      name: "missao",
      message: `${balconista}:\nEscolha sua missão:\n`,
    ...
    try {
      ...
      // Lógica de missões
      switch (
        answers.missao // usamos o switch case para seguir com as escolhes conforme escolhida pelo jogador
      ) {
        case "Caçar 3 Goblins":
          ...
          goblin1.adicionarHabilidade("Shield", 1.05, "Defesa");

          let goblinLanceiro = new Inimigo(
            "Goblin Lanceiro",
            40,
            40,
            2,
          ...
          let goblin3 = new Inimigo("Goblin", 45, 45, 3, 15, 15, 15, 30);
        ...
        case "Caçar 3 Slimes":
          let slime1 = new Inimigo("Slime Verde", 30, 30, 1, 10, 8, 4, 5);
          slime1.adicionarHabilidade("Pulo", 5, "Ataque");
          slime1.adicionarHabilidade("Gelatina", 1, "Defesa");

          let slime2 = new Inimigo("Slime Azul", 35, 35, 1, 4, 10, 3, 6);
          slime2.adicionarHabilidade("Mordida", 6, "Ataque");
          slime2.adicionarHabilidade("Gelatina", 1.2, "Defesa");

          let slime3 = new Inimigo("Slime Vermelho", 55, 55, 1, 20, 20, 2, 7);
          slime3.adicionarHabilidade("Golpe de Ácido", 10, "Ataque");
          slime3.adicionarHabilidade("Gosma Ácido", 15, "Especial");
          slime3.adicionarHabilidade("Gelatina", 2, "Defesa");
