...
export async function novaMissao(heroi) {
    ...
    const message = `${balconista}:\n Eu sei uma forma de melhorar as suas habilidades, o que acha de treinar na Torre de Batalha? Dizem que os grandes nomes desse mundo surgem de lá...\n`;
    const missoes = [
